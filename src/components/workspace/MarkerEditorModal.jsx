...
export default function MarkerEditorModal({ markerIdx, onClose, onDelete }) {
    ...
    <div className="modal-overlay open" id="marker-editor-modal">
      <div className="modal">
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '1rem', marginTop: '2rem' }}>
          <button className="btn btn-danger" style={{ marginRight: 'auto' }} onClick={() => onDelete(markerIdx)}>Delete Marker</button>
