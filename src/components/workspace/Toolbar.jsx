  ...
  return (
    <div className="workspace-toolbar">
      ...
      <ToolbarButton
        ...
        icon={<span style={{ fontSize: '0.72rem', fontWeight: 800, letterSpacing: '-0.03em' }}>{isNumbers ? '123' : 'ABC'}</span>}
      />
      ...
      {/* 8/9 — Layers (buildings + shadows) group */}
      <div className="toolbar-group">
        <ToolbarButton
          ref={toggleBtnRef}
          id="layers-toggle-btn"
          label="Layers"
          active={state.mode === 'buildings' || state.showShadows}
